...
@section('content')
    <div class="container">
        ...
        <h3>
            Daftar Harga Alat Musik
           
        </h3>
        <a class="btn btn-primary btn-sm float-end" href="{{ url('musik/create') }}">
...
<table class="table table-bordered">
            ...
            @foreach ($rows as $row)
                <tr>
                    ...
                    <td>
                    <a href="{{ url('musik/' . $row->id_alat . '/edit') }}" class="btn btn-warning btn-sm" role="button">
